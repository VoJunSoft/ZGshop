        ...
        cartItems.map((item, index)=>(
            <DropShadow  style={{
                ...
                <View style={CSS.cart}>
                    ...
                    <Text style={[CSS.title,{width:'10%'}]}>1</Text>
             ...
             <DropShadow  style={{
                ...
                shadowRadius: 2,
                    ...
                    <View style={[CSS.header]}>
                        <Text style={[CSS.title, {color:'#fac300'}]}>מחיקה</Text>
                        <Text style={[CSS.title, {color:'#fac300',width:'20%'}]}>מחיר</Text>
                        <Text style={[CSS.title, {color:'#fac300',width:'10%'}]}>כמ</Text>
                        <Text style={[CSS.title, {color:'#fac300',width:'30%'}]}>פרטים</Text>
                        <Text style={[CSS.title,{color:'#fac300',width:'30%'}]}>שם מוצר</Text>
                    </View>
            </DropShadow>
            {renderItems()}
